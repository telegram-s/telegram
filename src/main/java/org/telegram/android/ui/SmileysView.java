 ...
 */
public class SmileysView extends View {
    ...
    private OnSmileClickedListener onSmileClickedListener;
    private float touchX, touchY;

    public SmileysView(Context context, EmojiProcessor processor,
    ...
    public OnSmileClickedListener getOnSmileClickedListener() {
        return onSmileClickedListener;
    }

    public void setOnSmileClickedListener(OnSmileClickedListener onSmileClickedListener) {
