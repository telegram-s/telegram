...
/**
 * <p>The ExtraCursorFilter delegates most of the work to the ExtraCursorAdapter.
 ...
 * widgets.</p>
 */
class ExtraCursorFilter extends Filter {
    ...
    ExtraCursorFilter(CursorFilterClient client) {
        mClient = client;
    }
