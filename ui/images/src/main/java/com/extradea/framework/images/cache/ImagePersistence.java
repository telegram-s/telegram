...
public abstract class ImagePersistence {
    ...
    public abstract Bitmap loadImageOptimized(String id);

    public abstract Bitmap loadImageFill(String id, int maxWidth, int maxHeight);

    public abstract Bitmap loadImageOptimized(String id, int maxWidth, int maxHeight);

    public abstract void saveImage(Bitmap image, String id);

    public abstract void saveImage(byte[] image, String id);

    public abstract void clearPersistence();
}
