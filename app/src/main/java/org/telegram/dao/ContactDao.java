...
public class ContactDao extends AbstractDao<Contact, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property LocalId = new Property(2, long.class, "localId", false, "LOCAL_ID");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'CONTACT' (" + //
                ...
                "'LOCAL_ID' INTEGER NOT NULL );"); // 2: localId
        // Add Indexes
        db.execSQL("CREATE INDEX " + constraint + "IDX_CONTACT_UID_LOCAL_ID ON CONTACT" +
                " (UID,LOCAL_ID);");
    }
