...
public class PhoneFormat {
    ...
    public PhoneFormat(Context context, String countryCode) {
        init(context, countryCode);
    }

    public void init(Context context, String countryCode) {
        try {
            InputStream stream = context.getAssets().open("PhoneFormats.dat");
