...
JNIEXPORT int Java_org_telegram_opus_OpusLib_startRecord(JNIEnv *env, jclass class, jstring path) {
...
JNIEXPORT int Java_org_telegram_opus_OpusLib_writeFrame(JNIEnv *env, jclass class, jobject frame, jint len) {
    jbyte *frameBytes = (*env)->GetDirectBufferAddress(env, frame);
    return writeFrame(frameBytes, len);
}

JNIEXPORT void Java_org_telegram_opus_OpusLib_stopRecord(JNIEnv *env, jclass class) {
    cleanupRecorder();
}
...
JNIEXPORT jlong Java_org_telegram_opus_OpusLib_getTotalPcmDuration(JNIEnv *env, jclass class) {
    return _totalPcmDuration;
}

JNIEXPORT int Java_org_telegram_opus_OpusLib_getFinished(JNIEnv *env, jclass class) {
    return finished;
}

JNIEXPORT int Java_org_telegram_opus_OpusLib_getSize(JNIEnv *env, jclass class) {
    return size;
}

JNIEXPORT jlong Java_org_telegram_opus_OpusLib_getPcmOffset(JNIEnv *env, jclass class) {
    return pcmOffset;
}

JNIEXPORT void Java_org_telegram_opus_OpusLib_readOpusFile(JNIEnv *env, jclass class, jobject buffer, jint capacity) {
    jbyte *bufferBytes = (*env)->GetDirectBufferAddress(env, buffer);
    fillBuffer(bufferBytes, capacity);
}

JNIEXPORT int Java_org_telegram_opus_OpusLib_seekOpusFile(JNIEnv *env, jclass class, jfloat position) {
    return seekPlayer(position);
}

JNIEXPORT int Java_org_telegram_opus_OpusLib_openOpusFile(JNIEnv *env, jclass class, jstring path) {
    const char *pathStr = (*env)->GetStringUTFChars(env, path, 0);
...
JNIEXPORT void Java_org_telegram_opus_OpusLib_closeOpusFile(JNIEnv *env, jclass class) {
    cleanupPlayer();
}

JNIEXPORT int Java_org_telegram_opus_OpusLib_isOpusFile(JNIEnv *env, jclass class, jstring path) {
    const char *pathStr = (*env)->GetStringUTFChars(env, path, 0);
